...
docs_commit_autogen:
	...
	git diff --cached --exit-code || \
		git commit $(DOCS_AUTOGEN_FILES) \
		-m "DOC: autogenerated usage docs"
...
update_manifest:
	...
	git diff --exit-code || git add ./MANIFEST.in
	git commit ./MANIFEST.in -m "RLS: MANIFEST.in: autogenerated git_manifest"
